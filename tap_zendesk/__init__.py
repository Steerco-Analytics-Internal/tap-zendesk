...
SUB_STREAMS = {
    ...
    'articles': ['article_attachments', 'article_comments', 'article_votes'],
    'article_comments': ['article_comment_votes'],
    'posts': ['post_comments', 'post_votes'],
    'post_comments': ['post_comment_votes'],
}
